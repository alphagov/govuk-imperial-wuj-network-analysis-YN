# govuk-imperial-wuj-network-analysis-YN documentation build configuration file
#
...
project = "govuk-imperial-wuj-network-analysis-YN"
...
htmlhelp_basename = "govuk-imperial-wuj-network-analysis-YNdoc"
